...
int main(int argc,char *argv[])
{
    if (argc != 5)
    {
        ...
        printf("Example:/project/tools/bin/procctl 120 /project/idc/bin/obtcodetodb /project/idc/ini/stcode.ini "\
                  "\"idc/idcpwd@snorcl11g_124\" \"Simplified Chinese_China.AL32UTF8\" /log/idc/obtcodetodb.log\n\n");
    ...
    char *arg_inifile = argv[1],*arg_connstr = argv[2],*arg_charset = argv[3],*arg_logfile = argv[4],
    ...
    pactive.addpinfo(10,"obtcodetodb");   // 进程的心跳
    ...
    // 3）连接数据库。
    if (conn.connecttodb(arg_connstr,arg_charset)!=0)
    {
